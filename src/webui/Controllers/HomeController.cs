                                    ...
                                    "<body style=\"margin: 0; padding: 0; border: 0;\">" +
                                        "<div style=\"min-height: 100%; max-width: 800px; background-color: #DDDDDD; margin-left: auto; margin-right: auto; text-align: center;\">" +
                                            ...
                                            "<footer style=\"background-color: #8E8E8E; padding-top: 10px; padding-bottom: 10px;\">" +
                                                "<p style=\"font-size: 14px; color: #000000; opacity: 0.7;\">Designed by Utku POLAT</p>" +
                                                "<p style=\"font-size: 14px; color: #000000;\">For your questions and offers, contact <a href=\"mailto:utkupolat@protonmail.com\" style=\"font-size: 14px; color: #A76C00;\">utkupolat@protonmail.com</a></p>" +
                                            "</footer>" +
                                        "</div>" +
                                    "</body>" +
                                "</html>";
